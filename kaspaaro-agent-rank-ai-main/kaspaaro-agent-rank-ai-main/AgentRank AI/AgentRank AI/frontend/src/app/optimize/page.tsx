  ...
  useEffect(() => {
    ...
    if (cached) {
      try {
        ...
        const normalizedTargetStore = store ? store.toLowerCase().replace(/^https?:\/\//, '').split('/')[0] : '';
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        {!loading && !store && (
          <div className="text-center py-20 glass rounded-2xl border border-white/10">
            ...
            <p className="text-sm text-white/50 mb-4">Please connect a store to view its Product Optimization report.</p>
